...
|  接口  | 说明 |
|------ |----- |
|[/emotic/readEmotic](#readEmotic)| <font color=red>查询过审表情包</font>|
...
* <span id = "login">登录接口</span>
    ...
    * JSON返回示例：
      {"code":200,"data":{"menu":[{"path":"/admin","name":"admin","label":"表情管理","icon":"picture","url":"Admin.vue"},{"path":"/emotic","name":"emotic","label":"表情管理(已审核)","icon":"picture","url":"Emotic.vue"}],"token":"5i6T130VG","message":"获取成功"}}
